...
Example test_pltIsWellTyped_TEnd_1:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv |- pUnit.
...
Example test_hasType_TUnit_1:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- unit : Unit.
...
Example test_hasType_TVar_normalVar_1:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; testGamma1; Peer "p1" |- idApp (Id "x") : Tnat.
Proof. apply T_Var. left. reflexivity. Qed.


Example test_hasType_TVar_placedVar_2:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; testDelta1; emptyVarEnv; Peer "px" |- idApp (Id "x") : Unit.
Proof. apply T_Var. right. split. - reflexivity. - reflexivity. Qed.


Example test_hasType_TAbs_1: 
    (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- lambda (Id "x") Tnat unit : Tnat ~> Unit.
Proof. apply T_Abs. apply T_Unit. Qed.


Example test_hasType_TAbs_2: 
    (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- lambda (Id "x") Tnat (idApp (Id "x")) : Tnat ~> Tnat.
Proof. apply T_Abs. apply T_Var. left. reflexivity. Qed.


(** Tests variable shadowing **)
Example test_hasType_TAbs_3:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; testGamma1; Peer "_" |- lambda (Id "x") Unit (idApp (Id "x")) : Unit ~> Unit.
Proof. apply T_Abs. apply T_Var. left. reflexivity. Qed.


Example test_hasType_TApp_1:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- app (lambda (Id "x") Unit unit) unit : Unit.
Proof.
...
Example test_hasType_TApp_2: 
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- app (lambda (Id "x") Unit (idApp (Id "x"))) unit : Unit.
Proof.
  apply T_App with (T2 := Unit).
...
Example test_hasType_TNil_1: 
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- nil Unit : List Unit.
Proof. apply T_Nil. Qed.


Example test_hasType_TCons_1: 
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- cons unit (nil Unit) : List Unit.
Proof.
  apply T_Cons.
  - apply T_Unit.
  - apply T_Nil.
...
Example test_hasType_TSome_1: 
    (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- some unit : Option Unit.
Proof. apply T_Some. apply T_Unit. Qed.


Example test_hasType_TNone_1: 
    (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- none Unit : Option Unit.
Proof. apply T_None. Qed.


Example test_hasType_TPeer_1:
  (Program testTies1 testPeerTyping1) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "p0" |- peerApp (PeerInst 0) : Remote (Peer "p0").
...
Example test_hasType_TAsLocalFrom_single_1:
  (* ensure test setup is correct ... *)
  typed_peer_instances_type testPeerTyping1 (PeerInst 2) = Some (Peer "ps") /\
  testTies1 (Peer "p0", Peer "ps") = Some single /\
  (* actual test ... *)
...
Example test_hasType_TAsLocalFrom_optional_1:
  (* ensure test setup is correct ... *)
  typed_peer_instances_type testPeerTyping1 (PeerInst 3) = Some (Peer "po") /\
  testTies1 (Peer "p0", Peer "po") = Some optional /\
  (* actual test ... *)
  (Program testTies1 testPeerTyping1) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "p0"
...
Example test_hasType_TAsLocalFrom_multiple_1:
  (* ensure test setup is correct ... *)
  typed_peer_instances_type testPeerTyping1 (PeerInst 4) = Some (Peer "pm") /\
  testTies1 (Peer "p0", Peer "pm") = Some multiple /\
  (* actual test ... *)
  (Program testTies1 testPeerTyping1) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "p0"
...
Example test_hasType_TSignal_1:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- signal unit : Signal Unit.
Proof. apply T_Signal. apply T_Unit. Qed.


Example test_hasType_TReactiveVal_1:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- var unit : Var Unit.
Proof. apply T_ReactiveVar. apply T_Unit. Qed.


Example test_hasType_TNow_signal_1:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- now (signal unit) : Unit.
Proof.
...
Example test_hasType_TNow_var_1:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- now (var unit) : Unit.
Proof.
  eapply T_Now.
...
Example test_hasType_TSet_1:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- set (var unit) unit : Unit.
Proof.
...
Example test_hasType_TSet_2:
  (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy"
    |- set (var (lambda (Id "x") Unit unit))
           (*:=*) (lambda (Id "x") Unit unit)
    : Unit.
Proof.
  assert (H: (Program NoTies NoTypedInstances) :: emptyReactEnv; emptyPlaceEnv; emptyVarEnv; Peer "dummy" |- lambda (Id "x") Unit unit : Unit ~> Unit).
  - apply T_Abs.
    apply T_Unit.
